...
1. Customer selected in POS
   ...
   - `bonuscard_odoo/static/src/app/bonuscard_partner_search_patch.js` extends POS customer search to include phone (exact match) and Bonuscard recruitment code alongside the standard Odoo fields
